...
public class NIOConnectionFactory implements ConnectionFactory {
    ...
    @Override
    public ServerConnection createSecureServer(int port) throws IOException {
        return createServer(port);
    }

    @Override
    public ClientConnection createSecureClient(String host, int port) throws IOException {
